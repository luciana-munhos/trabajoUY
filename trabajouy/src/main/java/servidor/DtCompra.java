 ...
 *         <element name="paquete" type="{http://servidor/}dtPaquete" minOccurs="0"/>
...
public class DtCompra {
    ...
    protected DtCompra.CantActualTP cantActualTP;
    ...
    /**
     * Obtiene el valor de la propiedad cantActualTP.
     * 
     * @return
     *     possible object is
     *     {@link DtCompra.CantActualTP }
     *     
     */
    public DtCompra.CantActualTP getCantActualTP() {
        return cantActualTP;
    }

    /**
     * Define el valor de la propiedad cantActualTP.
     * 
     * @param value
     *     allowed object is
     *     {@link DtCompra.CantActualTP }
     *     
     */
    public void setCantActualTP(DtCompra.CantActualTP value) {
        this.cantActualTP = value;
    }
    ...
    public static class CantActualTP {

        protected List<DtCompra.CantActualTP.Entry> entry;
         ...
         * {@link DtCompra.CantActualTP.Entry }
         * 
         * 
         * @return
         *     The value of the entry property.
         */
        public List<DtCompra.CantActualTP.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<>();
            }
            return this.entry;
